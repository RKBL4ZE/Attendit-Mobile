...
void main() {
  ...
  tStudentAttendance.add(StudentAttendance(subjectCode: "BCA 202", subjectName: "Maths", lecturesAttended: 15, totalLectures: 20));
  tStudentAttendance.add(StudentAttendance(subjectCode: "BCA 302", subjectName: "Technical Comms.", lecturesAttended: 19, totalLectures: 20));
