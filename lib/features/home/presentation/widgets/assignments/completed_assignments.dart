                ...
                children: <Widget>[
                  ...
                  Padding(
                    ...
                    child: ConstrainedBox(
                      ...
                      child: completedassignment.length != 0
                          ? ListView.builder(
                                    ...
                                    children: [
                                      TableRow(
                                        children: [
                                          ...
                                          AutoSizeText(
                                            "${completedassignment[index].earnedMarks.toString()}/${completedassignment[index].assignment.totalMarks.toString()}",
                                            overflow: CardStyle.overflow,
                                            maxLines: CardStyle.maxLines,
                                            minFontSize: CardStyle.minFontSize,
                                            maxFontSize: CardStyle.maxFontSize,
                          ...
                          : Container(
                              ...
                              child: Text(
                                  'You do not have any completed assignment'),
                            ),
                    ),
                  ),
                ],
